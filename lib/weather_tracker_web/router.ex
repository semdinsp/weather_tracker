defmodule WeatherTrackerWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {WeatherTrackerWeb.Layouts, :root}
  ...
  # Other scopes may use custom stacks.
   scope "/api", WeatherTrackerWeb do
     pipe_through :api
     post "/weatherconditions", WeatherConditionsController, :create
   end
  ...
  if Application.compile_env(:weather_tracker, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: WeatherTrackerWeb.Telemetry
